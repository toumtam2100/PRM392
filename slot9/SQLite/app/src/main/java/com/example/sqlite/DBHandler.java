...
public class DBHandler extends SQLiteOpenHelper {
    ...
    // this method is use to add new course to our sqlitedatabase.
    ...
    public ArrayList<CourseModal> readCourses() {
        ...
        if (cursorCourses.moveToFirst()) {
            do {
                // on below line we are adding the data fromcursor to our array list.
                courseModalArrayList.add(new
                    CourseModal(cursorCourses.getString(1),
